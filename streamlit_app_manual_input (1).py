...
vs_pitcher_avg = st.number_input("AVG vs Pitcher (enter 0 if none)", min_value=0.0, max_value=1.0, step=0.001)
home_away_avg = st.number_input("Home/Away AVG", min_value=0.0, max_value=1.0, step=0.001)
handedness_avg = st.number_input("AVG vs Handedness", min_value=0.0, max_value=1.0, step=0.001)
